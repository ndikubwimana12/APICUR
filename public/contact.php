...
<head>
    ...
    <title>APICUR TSS — Contact</title>
...
<body class="min-h-screen bg-gray-50 text-gray-900 antialiased dark:bg-gray-950 dark:text-gray-100">
        ...
        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-8 text-xl leading-relaxed text-white/90 max-w-3xl mx-auto">
                    Reach our admissions and administration team. We're here to help with applications, programs, and
                    visits.
                </p>

                <div class="mt-12">
                    <a href="#contact-form" class="btn-primary text-lg px-8 py-4">
                        Send Message
            ...
            <div class="grid gap-12 lg:grid-cols-2">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-300">APICUR TSS<br />Musanze, Rwanda</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-300">info@apicur.tss.rw</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-300">Mon–Fri: 8:00 AM – 4:00 PM</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="reveal" id="contact-form">
                    ...
                    <form class="space-y-6"
                        onsubmit="event.preventDefault(); alert('Message sent successfully! We will get back to you soon.'); this.reset();">
    ...
    <section class="py-20 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-900">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-8">Visit Our Campus</h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
                    Schedule a visit to experience our facilities, meet our faculty, and see our programs in action.
                </p>
                    ...
                    <div class="glass-card p-8 text-center reveal">
                        <div class="w-16 h-16 bg-indigo-500 rounded-full flex items-center justify-center mx-auto mb-4">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 7V3m8 4V3m-9 8h10M5 17h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z">
                                </path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Virtual Tour</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Explore our campus from anywhere with our
                            interactive virtual tour.</p>
                        <a href="#" class="text-indigo-600 hover:text-indigo-700 font-medium">Take Virtual Tour →</a>
                    </div>
                    <div class="glass-card p-8 text-center reveal">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Group Tours</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Join a guided tour with our admissions team and
                            current students.</p>
                        <a href="./admissions.php" class="text-indigo-600 hover:text-indigo-700 font-medium">Schedule
                            Tour →</a>
                    </div>
                    <div class="glass-card p-8 text-center reveal">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Information Session</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Attend an online information session to learn
                            more about our programs.</p>
                        <a href="./admissions.php" class="text-indigo-600 hover:text-indigo-700 font-medium">Learn More
                            →</a>
                    </div>
                </div>
            </div>
